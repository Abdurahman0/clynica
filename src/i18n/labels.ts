...
const USER_PERMISSION_LABEL_KEYS: Record<string, string> = {
  ...
  can_view_conversations: 'labels.permissions.can_view_conversations',
  can_manage_conversations: 'labels.permissions.can_manage_conversations',
  can_manage_users: 'labels.permissions.can_manage_users',
  can_view_users: 'labels.permissions.can_view_users',
  ...
  can_view_bookings: 'labels.permissions.can_view_bookings',
  ...
  can_view_audit_logs: 'labels.permissions.can_view_audit_logs',
  ...
  'bookings.view': 'labels.permissions.bookings.view',
  'bookings.manage': 'labels.permissions.bookings.manage',
  'conversations.view': 'labels.permissions.conversations.view',
  'conversations.manage': 'labels.permissions.conversations.manage',
  'settings.view': 'labels.permissions.settings.view',
...
const USER_PERMISSION_DESCRIPTION_KEYS: Record<string, string> = {
  ...
  can_view_conversations: 'labels.permissionDescriptions.can_view_conversations',
  can_manage_conversations: 'labels.permissionDescriptions.can_manage_conversations',
  can_manage_users: 'labels.permissionDescriptions.can_manage_users',
  can_view_users: 'labels.permissionDescriptions.can_view_users',
  ...
  can_view_bookings: 'labels.permissionDescriptions.can_view_bookings',
  ...
  can_view_audit_logs: 'labels.permissionDescriptions.can_view_audit_logs',
  ...
  'bookings.view': 'labels.permissionDescriptions.bookings.view',
  'bookings.manage': 'labels.permissionDescriptions.bookings.manage',
  'conversations.view': 'labels.permissionDescriptions.conversations.view',
  'conversations.manage': 'labels.permissionDescriptions.conversations.manage',
  'settings.view': 'labels.permissionDescriptions.settings.view',
